...
public class StringConstants {
    ...
    public static final String EMPTY_REWIEW_TEXT = "Review text can not be empty.";
    public static final String NO_REVIEW_SCORE = "You must provide review score.";
    ...
    public static final String IMAGE_ID_MUST_BE_POSITIVE_AND_GREATER_THAN_ZERO_ALSO_IT_CAN_BE_NULL = "Image id must be positive and greater than zero also it can be null";
    public static final String CAPACITY_MUST_BE_POSITIVE_AND_GREATER_THAN_ZERO_ALSO_IT_CAN_BE_NULL = "Capacity must be positive and greater than zero also it can be null";
    public static final String LOCATION_MUST_BE_NOT_NULL = "The location must be not null";
    ...
    public static final String EVENT_ID_CAN_NOT_BE_NULL = "Event id can not be null";
    public static final String EVENT_ID_MUST_BE_POSITIVE_AND_GREATER_THAN_ZERO = "Event id must be positive and greater than zero";
