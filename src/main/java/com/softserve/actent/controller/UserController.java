...
public class UserController {
    ...
    public ResponseEntity<UserDto> addUser(@RequestBody RegisterUserDto registerUserDto) {
    ...
    public ResponseEntity<UserDto> updateUserById(@RequestBody UserSettingsDto userSettingsDto, @PathVariable Long id) {
