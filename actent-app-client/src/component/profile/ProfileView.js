            ...
            <div className = "styleMain">
                <div className= "styleLowerMain1">
                    ...
                    <div>
                        ...
                        <p className="styleInput"><span className="styleSpan">Address:</span>{this.props.profileData.address.name || null},
                            {this.props.profileData.address.regionCountryName || null}</p>
